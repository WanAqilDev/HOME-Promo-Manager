...
// Status read for reactivation logic:
$new_status = \FrmEntryMeta::get_entry_meta($entry_id, (int)$mgr->s('status_field_id'));
...
add_action('frm_after_update_entry', function($entry_id, $form_id) {
    ...
    // new status:
    $new_status = get_entry_meta($entry_id, (int)$mgr->s('status_field_id'));
