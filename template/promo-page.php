...
?>><head><meta charset="<?php bloginfo('charset'); ?>"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title><?php the_title();

?>– 12.12 Promo</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Fredoka:wght@600;700&family=Modak&display=swap" rel="stylesheet"><script src="https://cdn.tailwindcss.com"></script><script src="https://cdn.jsdelivr.net/npm/canvas-confetti@1.6.0/dist/confetti.browser.min.js"></script><style>body {
    background: <?=$bg_blue ?>;
    min-height: 100vh;
...
</style></head><body><div id="background-wrap"><div class="x1"><div class="cloud"></div></div><div class="x2"><div class="cloud"></div></div><div class="x3"><div class="cloud"></div></div><div class="x4"><div class="cloud"></div></div><div class="x5"><div class="cloud"></div></div></div><main class="flex-grow flex flex-col justify-center items-center relative z-10 w-full px-4 pt-10 pb-10"><div class="promo-container"><div class="title-promosi">PROMOSI</div><div class="title-1212">12.12</div><div class="title-ozem">OZEM DEALS</div><div class="pill-discount">POTONGAN DISKAUN SEHINGGA 24%</div><p class="desc-text">Promosi terhad kepada <em style="color:#F80588;"><b>480 pendaftaran terawal sahaja</b></em>.<br>Jangan lepaskan peluang anda ! </p><div id="flipClock" class="flip-clock"></div><div class="labels-container"><span class="flip-label">Days</span><span class="flip-label">Hours</span><span class="flip-label">Minutes</span><span class="flip-label">Seconds</span></div><div id="liveStats" class="live-stats-wrapper"><div class="stat-card is-code"><div id="priceDisplay"></div></div><div class="stat-card is-slots"><span class="stat-label">Kekosongan (Tier Ini)</span><span id="apiSlots" class="stat-value-slots">...</span></div><div class="w-full text-center mt-1"><span class="text-xs font-semibold text-gray-700 bg-white/80 px-2 py-1 rounded">Baki Keseluruhan: <span id="apiTotal">...</span></span></div></div><div class="pill-date">12 - 24 Disember 2025</div><div class="text-tnc">*Terma & Syarat*</div></div></main><div class="footer-strip"><span class="footer-strip-txt">HOME Math Therapy &copy;
<?=date('Y')?>&nbsp;
&bull;
&nbsp;
Powered by QCXIS Sdn Bhd</span></div><div class="confetti-bg" id="confettiBg"></div><script> // --- CONFIG ---
...
async function updateRealtimeStats() {
    try {
        ...
        let priceHtml=` <div class="original-price">$ {
            priceData.originalFormatted
        }

        </div><div class="discount-info">JIMAT BESAR $ {
        ...
        % ! ($ {
            ...
            })</div><div class="final-price">$ {
            priceData.finalFormatted
        }

        </div><div class="stat-label mt-3">Harga Semasa (Kod: $ {
                priceData.promoCode
            })</div>`;
...
function renderClock(parts, animate=true) {
    ...
    for (let i=0; i<4; i++) {
        ...
        html+=<div class="flip-unit"><div class="flip-digit${flip?' flip-anim':''}" id="flip${i}">$ {
            pad(parts[i])
        }
